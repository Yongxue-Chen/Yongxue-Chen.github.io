        ...
        <div class="project-body">
          {% if project.meta_en %}
            ...
            <div class="project-meta">
              <span class="lang-en"><span class="project-journal">{{ meta_en_parts | first }}</span>{% for part in meta_en_parts offset: 1 %}<span class="project-year">{{ part }}</span>{% endfor %}</span>
              <span class="lang-zh"><span class="project-journal">{{ meta_zh_parts | first }}</span>{% for part in meta_zh_parts offset: 1 %}<span class="project-year">{{ part }}</span>{% endfor %}</span>
            </div>
          {% endif %}
